...
// configuration step. It creates a namespace called `DisarmSelfDestruct`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        DisarmSelfDestruct::cmake::project_name,
        DisarmSelfDestruct::cmake::project_version));// version string, acquired
